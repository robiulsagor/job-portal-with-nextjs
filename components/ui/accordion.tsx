  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        {/* Icon container — uses data-state from Trigger via Tailwind group */}
        <span className="ml-2">
          <PlusCircle className="size-6 text-muted-foreground group-data-[state=open]:hidden" />
          <XCircle className="size-6 text-muted-foreground hidden group-data-[state=open]:block" />
        </span>
      </AccordionPrimitive.Trigger>
